...
AS   
	...
	declare @condition nvarchar(250),
			@query nvarchar(2048)
	set @query = 'SELECT distinct TOP '+CAST(@resultsCount AS NVARCHAR(10))
...
--exec SearchAccounts @index = 6, @searchTerm = N'CASH', @resultsCount = 200
--exec SearchAccounts @index = 5, @searchTerm = N'5486', @resultsCount = 200
--exec SearchAccounts @index = 4, @searchTerm = N'91', @resultsCount = 2000
